...
df_15 = pd.read_excel("/home/marcos/Downloads/Table_8_Offenses_Known_to_Law_Enforcement_by_State_by_City_2015.xls", "15tbl08")
...
for typec in types:
    print typec
    df_15_ = df_15[df_15['Population'] > 10000]
    ...
    for m in models:
        line = typec.replace("\n", " ") + ","
        r = m(data_xy, required_successes=1)
        line += m.description + ", "
        line += ",".join(r.beta) + ", "
        line += r.bic + ", "
        line += r.p_value + ", "
